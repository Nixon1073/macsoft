...
#icon
image_icon=PhotoImage(file="D:\Image/icon.png")
...
#logo
photo=PhotoImage(file="D:\Image/laptop.png")
...
def none():
    ...
    if battery.power_plugged==True:
        battery_png=PhotoImage(file="D:\Image/charging.png")
        battery_label.config(image=battery_png)
         
    else:
        battery_png=PhotoImage(file="D:\Image/battery.png")
        battery_label.config(image=battery_png)
...
def weather():
    ...
    #icon
    image_icon=PhotoImage(file='D:\Image/App1.png')
    ...
    #search box
    Search_image=PhotoImage(file="D:\Image/search.png")
...
def clock():
    ...
    #icon
    image_icon=PhotoImage(file="D:\Image/App2.png")
...
def calendar():
    ...
    #icon
    image_icon=PhotoImage(file="D:\Image/App3.png")
...
def game():
    ...
    #icon
    image_icon=PhotoImage(file='D:\Image/App5.png')
    app5.iconphoto (False,image_icon)
    ludo_image=PhotoImage(file="D:\Image/ludo back.png") 
    ...
    btn_image=PhotoImage(file="D:\Image/ludo button.png")
